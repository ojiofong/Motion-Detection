...
FLAGS_model_dir = '/Users/oofong/Projects/Hackathon/HackathonProject/old_deprecated_kitchenbot/model'
...
class ClassifyImage:
    ...
    def run_inference_on_image(self, imagePath):
        ...
        print("[ClassifyImage]", human_string, score)
        ...
        if alarm.isWindowSlideNeeded(human_string, score):
            ...
            relativeSize = int(100 + image.shape[0] / 2)
            ...
            for (x, y, window) in sw.sliding_window(image, stepSize=32, windowSize=(winW, winH)):
                ...
                human_string, score = self.predict(imagePath)
                alarm.processAlarm(human_string, score, isWindowSlide=True)
    ...
    def predict(self, imagePath):
        ...
        with tf.Session() as sess:
            ...
            for node_id in top_k:
                ...
                print('[TF] %s (score = %.5f)' % (human_string, score))

            # Just grab the first
            node_id = top_k[0]
            human_string, score = node_lookup.id_to_string(node_id), predictions[node_id]
    ...
    def test(self):
        ...
        imagePath = '/Users/oofong/Projects/Hackathon/HackathonProject/temp1.jpg'
        self.run_inference_on_image_async(imagePath)
